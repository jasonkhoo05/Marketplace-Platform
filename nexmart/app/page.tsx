...
export default function Home() {
  return (
    <main className="min-h-screen flex flex-col w-full" style={{ 
      background: "#f5faf8" 
      }}>
      ...
      <nav className="flex justify-between items-center px-8 py-4 border-b sticky top-0 z-50" 
        ...
        <div className="flex gap-2 items-center">
          <Link href="/login" className="px-4 py-2 flex items-center justify-center rounded-lg text-sm font-semibold border" 
            style={{ 
      ...
      <section className="grad grid md:grid-cols-2" style={{ 
          minHeight: 460 
        }}>
        ...
        <div className="flex flex-col justify-center px-10 py-16">
          ...
          <h2 className="text-4xl font-extrabold text-white mb-4" style={{ 
              lineHeight: 1.15 
            }}>
              Buy and sell anything - without the hassle
          </h2>
          <p className="text-sm mb-7" style={{ 
            color: "rgba(255,255,255,0.78)", lineHeight: 1.65, maxWidth: 340 
            }}>
          ...
          <div className="flex flex-wrap gap-2">
            {["All", "Electronics", "Fashion", "Home", "Sports"].map((tag, i) => (
              <span key={tag} 
                className={`hero-tag${i === 0 ? " hero-tag-active" : ""}`}>
                  {tag}</span>
            ))}
          </div>
        </div>
      ...
      <div className="flex justify-center bg-white border-b" style={{ 
        ...
        <div className="why-text bg-white">
          <p className="eyebrow">Why NexMart</p>
            <h3 className="text-2xl font-extrabold mb-3" 
              style={{ color: "#0d2b22", lineHeight: 1.25 }}>
          ...
          <div className="flex flex-col gap-2.5">
            {["No complicated listing forms", 
              "Instant buyer-seller chat", 
              "Dashboard to track all orders"].map((c) => (
        ...
        <div className="why-visual" style={{ background: "#f2faf7" }}>
          <div className="mock-wrap">
            ...
            <div className="mock-card" style={{ 
              ...
              <p className="text-xs font-semibold mb-0.5" style={{ 
                  color: "#0d2b22" }}>Buyer connected</p>
              <p style={{ 
                  fontSize: 10, color: "#4a7060" }}
                  >Offer received · $82
              </p>
      ...
      <div className="grid md:grid-cols-2">
          ...
          <div className="mock-wrap">
            ...
            <div className="mock-card" 
              ...
              <div className="mock-icon" style={{ 
                background: "linear-gradient(135deg,#1d9e75,#185fa5)" }}
                >
                <svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" />
                </svg>
              </div>
              <p className="text-xs font-semibold mb-0.5" 
                style={{ 
        ...
        <div className="why-text" style={{ 
            background: "#f2faf7" }
            }>
          <p className="eyebrow">Secure & Fast</p>
          <h3 className="text-2xl font-extrabold mb-3" style={{ 
              color: "#0d2b22", lineHeight: 1.25 }}>
          ...
          <div className="flex flex-col gap-2.5">
            {["Encrypted payment processing", 
              ...
              "Dispute resolution support"].map((c) => (
              <div key={c} className="flex items-center gap-2 text-sm" 
                style={{ color: "#0d2b22" }}>
                <span style={{ 
                    width: 7, 
