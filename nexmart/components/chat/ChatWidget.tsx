  ...
  useEffect(() => {
    function handleRemoteOpenTrigger(e: Event) {
      ...
      const formatted: chat = {
        ...
        product_name: chatRow.prod_name || `Product Item #${chatRow.prod_id}`,
        product_price: chatRow.prod_price,
        product_desc: chatRow.prod_desc,
        product_stock: chatRow.prod_stock,
